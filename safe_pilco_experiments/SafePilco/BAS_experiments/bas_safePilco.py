...
seed = sys.argv[2]
BASBenchmarks_path = sys.argv[3] # for example: "/Users/kpol/Work/BASBenchmarks/src"
...
class BASWrapper1():
    def __init__(self, path_for_BASB):
        self.eng = matlab.engine.start_matlab()
        self.eng.addpath(self.eng.genpath(path_for_BASB));
...
if experim_num == 1:
    ...
    env = BASWrapper1(BASBenchmarks_path)
    max_temp = 20.5
else:
    ...
    weights[0,0] = 1.0; weights[1,1] = 1.0
    env = BASWrapper2(BASBenchmarks_path)
    max_temp = 20.5
...
for model in pilco.mgpr.models:
    model.likelihood.variance.assign(0.2)
...
for rollouts in range(N):
    ...
    pilco.optimize_policy(maxiter=25)
    if safe:
